const CACHE_NAME = 'history-game-v4';
const ASSETS_TO_CACHE = [
  ...
  // Characters and Items (Verified file list)
  ...
  './assets/images/card_imoko_1771331521760_down_1772110225693.png',
  './assets/images/card_imoko_1771331521760_up_1772110201753.png',
  ...
  './assets/images/card_murasaki_1771331235245.png',
  ...
  './assets/images/card_mutsu_1771336125082.png',
  ...
  './assets/images/card_nakanooe_1771331544522_down_1772239942511.png',
  './assets/images/card_nakanooe_1771331544522_up_1772239929292.png',
  './assets/images/card_nobunaga_1771327671796.png',
  ...
  './assets/images/card_okubo_1771335625732_down_1772110946642.png',
  ...
  './assets/images/card_tokimune_1771335239525.png',
  ...
  './assets/images/item_osakaexpo.png',
  ...
  './assets/images/item_smartphone.png',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME).then((cache) => {
      console.log('Opened cache v4 (Robust Cache)');
      // Cache files individually so that one failure doesn't stop the rest
      return Promise.all(
